...
- **Output Captured & Structured:**
  - Raw consensus responses saved to:
    ...
    ```
    outputs_m1/stage_02_consensus/
    ```

  - Structured consensus results saved to:

    ```
    outputs_m1/stage_02_consensus_structured/
    ```
...
- **Score Output Captured & Structured:**
  - Raw scoring responses saved to:
    ...
    ```
    outputs_m1/stage_03_scoring/
    ```

  - Structured scoring results saved to:

    ```
    outputs_m1/stage_03_scoring_structured/
    ```
...
1. **Parse:**
   ...
   - Saved to:
     ...
     ```
     outputs_m1/stage_04_raw_scores/
     ```
...
2. **Aggregation:**
   ...
   - Saved to:
     ...
     ```
     outputs_m1/stage_04_aggregated_scores/
     ```
...
3. **Internal Weightage System:**
   ...
   - Weighted results saved to:
     ...
     ```
     outputs_m1/stage_04_weighted_scores/
     ```
...
4. **Token Summary Generation:**
   ...
   - Saved to:
     ...
     ```
     outputs_m1/stage_05_token_summary/
     ```
...
6. **CSV Export:**
   - `export_csv()` saves reports to:
     ...
     ```
     outputs_m1/stage_05_token_report_stage/
     outputs_m1/stage_05_token_report_model_summary/
     ```
