...
MODULE_NAME = "AI_CONSENSUS_SYSTEM_M2"
...
async def run_ai_consensus_system_m2():
    try:
        # =========================
        ...
        initial_log_messages = [f"{MODULE_NAME} | START | AI_CONSENSUS_SYSTEM_M2_V2"]
        ...
        random_map = generate_random_model_mapping(  
            ...
            directory="outputs/stage_03_model_mapping"
        )
